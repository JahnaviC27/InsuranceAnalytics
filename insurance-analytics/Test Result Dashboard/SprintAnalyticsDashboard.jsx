...
const SprintAnalyticsDashboard = () => {
  ...
  const [filters, setFilters] = useState({
    portfolio: 'Policy Core Systems',
    domain: 'Auto',
    environment: 'QA01',
    category: 'Regression',
    sprintName: 'Sprint-Q34276'
  });

  const portfolioDomains = {
    'Policy Core Systems': ['Auto', 'Property'],
    'Policy Modernization': ['Auto', 'P3', 'Dwelling', 'Umbrella'],
    'Claims': ['Claims'],
    'Data': ['Data'],
    'Shared Solutions': ['BASE', 'PICS', 'FINPAL'],
    'D&S': ['Salesforce CRM', 'P&C Mobile', 'Digital', 'Agency'],
    'NBV&I': ['Future of Auto', 'Innovation', 'SBI', 'OEM', 'Expanded Distribution', 'Auto Ecosystem'],
    'ASC': ['ASC']
  };

  const domainOptions = useMemo(() => portfolioDomains[filters.portfolio] || [], [filters.portfolio]);
      ...
      <div style={styles.filtersSection}>
        <div style={styles.filters}>
          <div style={styles.filterGroup}>
            <label style={styles.label}>Portfolios</label>
            <select 
              style={styles.select}
              value={filters.portfolio}
              onChange={(e) => {
                const val = e.target.value;
                setFilters(prev => ({ ...prev, portfolio: val, domain: (portfolioDomains[val] || [])[0] || '' }));
              }}
            >
              <option>Policy Core Systems</option>
              <option>Policy Modernization</option>
